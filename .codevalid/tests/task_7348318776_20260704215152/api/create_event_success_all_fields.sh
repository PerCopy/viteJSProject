...
EVENT_DESCRIPTION="Annual technology summit ${CASE_SUFFIX}"
EVENT_LOCATION="Convention Center, Hall A ${CASE_SUFFIX}"
START_DATE="2025-03-15T09:00:00Z"
END_DATE="2025-03-17T18:00:00Z"
RESPONSE_FILE="/tmp/create_event_success_all_fields_${CASE_SUFFIX}.json"
STATUS_FILE="/tmp/create_event_success_all_fields_${CASE_SUFFIX}.status"
EVENT_ID=""
cleanup_files() {
...
# Given
: "Prepare a unique event payload with all supported fields"
...
echo "CODEVALID_TEST_ASSERTION_OK:create_event_success_all_fields"
